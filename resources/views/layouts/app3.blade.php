...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('login-form-07/images/icon.jpeg') }}">
    <!-- Pignose Calender -->
...
<body>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        @can('manage-admins')
                        <a class="has" href="http://127.0.0.1:8000/users" aria-expanded="false">
                            <i class="icon-user menu-icon"></i> <span class="nav-text">Users</span>
                        </a>
                        @endcan
                    </li>
                    <li>
                        <a class="has" href="http://127.0.0.1:8000/penduduks" aria-expanded="false">
                            <i class="icon-user menu-icon"></i> <span class="nav-text">Penduduk</span>
                        </a>
                    </li>

                    <li>
                        <a class="has" href="http://127.0.0.1:8000/kartuKeluargas" aria-expanded="false">
                            <i class="icon-folder menu-icon"></i> <span class="nav-text">Kartu Keluarga</span>
                        </a>
                    </li>

                    <li>
                        <a class="has" href="http://127.0.0.1:8000/kelahirans" aria-expanded="false">
                            <i class="icon-heart menu-icon"></i><span class="nav-text">Surat Kelahiran</span>
                        </a>
                    </li>

                    <li>
                        <a class="has" href="http://127.0.0.1:8000/kematians" aria-expanded="false">
                    ...
                    <li>
                        <a href="http://127.0.0.1:8000/calenderp" aria-expanded="false">
                            <i class="icon-calender menu-icon"></i><span class="nav-text">Calender</span>
                        </a>
                    </li>
                    @endcan
    ...
    ***********************************-->
    ...
    <script src="{{ asset('quixlab/./plugins/jqueryui/js/jquery-ui.min.js') }}"></script>
    <script src="{{ asset('quixlab/./plugins/moment/moment.min.js') }}"></script>
    <script src="{{ asset('quixlab/./plugins/fullcalendar/js/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('quixlab/./js/plugins-init/fullcalendar-init.js') }}"></script>

    <!--Form Penduduk dll -->
    <script src="{{ asset('quixlab/./plugins/validation/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('quixlab/./plugins/validation/jquery.validate-init.js') }}"></script>
</body>
